...
public class SuggestRecyclerViewAdapter extends RecyclerView.Adapter<SuggestRecyclerViewAdapter.CustomViewHolder> {
    ...
    public SuggestRecyclerViewAdapter(CardViewClickListener cardViewClickListener, Context context, ArrayList<Integer> locationId, ArrayList<String> locationName,
...
//        holder.txtLocationId.setText(String.valueOf(locationId.get(position)));
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            cardViewClickListener.onItemClick(position);
